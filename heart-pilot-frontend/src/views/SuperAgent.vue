...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: '心旅 AI 行动规划助手根据城市、时间、预算和偏好制定可执行的关系改善计划'
    },
    {
      name: 'keywords',
      content: '行动规划助手,约会计划,关系改善,AI智能体,任务规划'
    }
  ]
})
...
onMounted(() => {
  // 添加欢迎消息
  addMessage(
    '你好，我是心旅 AI 行动规划助手。请告诉我城市、日期、预算、双方偏好和你的目标，我会帮你制定约会或关系改善计划。',
    false
  )
})
